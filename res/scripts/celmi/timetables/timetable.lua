...
function timetable.beforeDepature(constraint, time)
    ...
    return ( (timeSec < ConstraintSec or timeSec > (ConstraintSec + 1800)) and ConstraintSec < 1800) or (timeSec < ConstraintSec and timeSec > (ConstraintSec - 1800) and ConstraintSec  >= 1800)
